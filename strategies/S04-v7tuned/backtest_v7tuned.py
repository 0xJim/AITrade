...
LEVERAGE = 3
RISK_PER_TRADE = 0.01        # 每笔固定风险: 总资金的1% ($50)
MAX_POSITIONS = 2
COOLDOWN_HOURS = 24           # 默认冷却
COOLDOWN_CONSECUTIVE_LOSS = 168  # v7: 同币种连亏后冷却7天(168h)
DAILY_MAX_LOSS_PCT = 3        # 每日亏3%停

# === v7t 策略阈值 ===
EXTREME_NEG_FUNDING = -0.10
EXTREME_POS_FUNDING = 0.15
MIN_ENV_SCORE = 5             # v7t: 5 (原4，过滤更多低质量信号)
MIN_RR_RATIO = 2.0
ATR_SL_MULTIPLIER = 3.0
ATR_SL_LOW_THRESHOLD = 0.02
MIN_SL_PCT = 0.03             # 最小止损3%
MAX_SL_PCT = 0.08             # v7t: 8% (原15%，控制高ATR币单笔亏损)
DEFAULT_SL_PCT = 0.04
DEFAULT_TP_PCT = 0.10
ATR_PERIOD = 14
EMA_FAST = 9
...
TREND_TRAIL_TRIGGER = 0.03    # v7t: 3% (原2%，让更多仓位进入跟随吃肉)
...
def run_backtest():
    ...
    out_path = Path(__file__).parent / "data" / "backtest_v7tuned_result.json"
