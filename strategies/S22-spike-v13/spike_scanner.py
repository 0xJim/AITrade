...
# === Spike 信号参数 ===
SPIKE_THRESHOLD = float(os.environ.get("SPIKE_THRESHOLD", globals().get("SPIKE_THRESHOLD", 0.01)))
SPIKE_MIN_ATR = float(os.environ.get("SPIKE_MIN_ATR", globals().get("SPIKE_MIN_ATR", 0.005)))
SPIKE_COOLDOWN_SECS = int(os.environ.get("SPIKE_COOLDOWN_SECS", globals().get("SPIKE_COOLDOWN_SECS", 3600)))
SPIKE_LONG_ONLY = os.environ.get("SPIKE_LONG_ONLY", str(globals().get("SPIKE_LONG_ONLY", "true"))).lower() == "true"
SPIKE_REQUIRE_EMA_UP = os.environ.get("SPIKE_REQUIRE_EMA_UP", str(globals().get("SPIKE_REQUIRE_EMA_UP", "true"))).lower() == "true"
SPIKE_MIN_RSI = float(os.environ.get("SPIKE_MIN_RSI", globals().get("SPIKE_MIN_RSI", 50)))
