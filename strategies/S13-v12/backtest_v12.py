...
def run_backtest():
    ...
    print(f"v12b优化: RSI做多<65(仅过滤超买) | 做多仓位0.5x | 信号排序优先做空 | 杠杆3x")
    print("=" * 60)
    ...
    out_path = Path(__file__).parent / "data" / "backtest_v12_result.json"
