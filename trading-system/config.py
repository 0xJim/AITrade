...
# ═══════════════════════════════════════════════════════════════════
# v11j新增: 单笔亏损上限 — 回测15方案中碾压最优的因子
# ═══════════════════════════════════════════════════════════════════
# 回测对比(1000U/1年, 基线v11i: 1274笔/62.7%/+$6983/DD43.1%):
#
# 方案M(仅上限$40) ★当前启用 — 最优:
#   1274笔/62.7%/$+11462/DD10.6%/PF1.95/月33/34盈利/月胜97.1%/ROI/DD=108.5
#   vs基线: PnL +64%, DD -75%, 月胜率 +14.7pp, ROI/DD ×6.7
#
# 方案D(上限$60) — 次选:
#   1274笔/62.7%/$+9135/DD16.3%/PF1.64/月30/34/月胜88.2%/ROI/DD=56.1
#
# 方案G(连亏×0.5+上限$60) — 第三:
#   1274笔/62.7%/$+9084/DD15.7%/PF1.66/月30/34/月胜88.2%/ROI/DD=57.9
#
# 方案H(⑥号方案: SL≤8%+连亏×0.5+上限$60) — 排名5:
#   1146笔/61.8%/$+7070/DD15.4%/PF1.56/月29/34/月胜85.3%/ROI/DD=45.8
#
# 方案I(加强版: SL≤7%+连亏×0.4+上限$50) — 最激进:
#   1064笔/61.7%/$+6464/DD9.9%/PF1.60/月30/34/月胜88.2%/ROI/DD=65.0
#
# 结论: 单笔亏损上限是最强因子，收紧SL反而亏钱。
#        方案M只改一个参数(上限$40)，不触及其他逻辑，风险最小。
# ═══════════════════════════════════════════════════════════════════
