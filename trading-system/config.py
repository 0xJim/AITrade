...
DATA_FAPI = BINANCE_CONFIG.get(
    "BINANCE_DATA_FAPI",
    os.environ.get("BINANCE_DATA_FAPI", "https://fapi.binance.com"),
).rstrip("/")
TRADE_FAPI = BINANCE_CONFIG.get(
    "BINANCE_TRADE_FAPI",
    os.environ.get(
        "BINANCE_TRADE_FAPI",
...
ENABLE_LIVE_TRADING = BINANCE_CONFIG.get(
    "ENABLE_LIVE_TRADING",
    os.environ.get("ENABLE_LIVE_TRADING", "false"),
).lower() == "true"

LIVE_CONFIRM = BINANCE_CONFIG.get(
    "LIVE_CONFIRM",
